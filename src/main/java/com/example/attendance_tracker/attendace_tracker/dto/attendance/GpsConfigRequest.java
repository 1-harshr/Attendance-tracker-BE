...
public class GpsConfigRequest {
    ...
    public GpsConfigRequest() {}
    
    public GpsConfigRequest(Boolean gpsValidationEnabled, Double officeLatitude, Double officeLongitude, Double allowedRadius) {
